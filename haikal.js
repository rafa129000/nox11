...
// Base © °noxa°Hw Mods : Copyan Dari Base Dika
...
{
"optionName": "SALAM BROTHER BY © °noxa°͢"
}
],
...
haikal.sendMessage(m.chat, {document: yy, mimetype: 'application/octet-stream', fileName:`© °zilo°APIs ~ 404 ${buttonkal}.HW` }, {quoted:doc})
}
}
break
//=================================================//
...
for (let i = 0; i < jumlah; i++) {
 ...
 haikal.sendMessage(m.chat, {document: ilih, mimetype: '', fileName:`© °zilo°APIs ~ 404 ${buttonkal}.HW` }, {quoted:doc})
 }
 }
 break
//=================================================//
...
"status": "INQUIRY",
"surface": "CATALOG",
"message": `© © °zilo°͢${ngazap(prefix)}`,
"jpegThumbnail":fs.readFileSync('./baseikal/image/pict.jpg'),
"orderTitle": `© © °zilo°͢${ngazap(prefix)}`,
...
"retailerId": `© © °zilo°WE ARE NOT MASTOD`,
...
haikal.sendMessage(m.chat, anuala, `© °zilo°͢${ngazap(prefix)}`, m)
}
}
break
case 'bugcrot' :
...
┗━━⊱
 ▰▱▰▱▰▱▰▱▰▱▰▱▰▱
© °noxa°͢`, contextInfo:{"externalAdReply": {"title": `SC °noxa°͢`,"body": `Selamat ${salam} kak ${pushname}`,
previewType: "PHOTO",
showAdAttribution: true,
sourceUrl: `https://youtube.com/c/HwModsWa857`,
thumbnailUrl: 'https://telegra.ph/file/a5e229afeb4dad4f35204.jpg', 
...
┏━━⊱[ GROUP ]
┣❏gasnoxa 112674448xxx
┣❏noxasantetgc  1237891xxxx@g.us|10|10s
...
┗━━⊱[°noxa°]`,
contextInfo:{"externalAdReply": {"title": `SC °noxa°͢`,"body": `Selamat ${salam} kak ${pushname}`,
previewType: "PHOTO",
showAdAttribution: true,
}
}}, { quoted:m})
